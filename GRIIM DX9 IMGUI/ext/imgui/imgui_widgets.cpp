...
bool ImGui::ButtonEx(const char* label, const ImVec2& size_arg, ImGuiButtonFlags flags)
{
    ...
    */
    ...
    // Render
    const ImU32 col = ((held && hovered) ? ImColor(32, 33, 35) : hovered ? ImColor(22, 118, 243) : ImColor(32, 33, 35));
    RenderNavHighlight(bb, id);
    RenderFrame(bb.Min, bb.Max, col, 0, 5);
    window->DrawList->AddRect(bb.Min, bb.Max, ImColor(32, 33, 35), 5);

    window->DrawList->AddText(bb.GetCenter() - label_size / 2, hovered ? ImColor(192, 203, 229) : ImColor(192, 203, 229)/*test*/ , label);
